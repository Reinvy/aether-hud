...
import { Send, Lock, Terminal, GitBranch, Globe, MessageCircle, Mail, CheckCircle, User, AtSign, Hash, ChevronRight, BookOpen, GitFork } from "lucide-react";
...
const socialIcons: Record<string, React.ElementType> = {
  GitBranch, Globe, MessageCircle, BookOpen, GitFork,
};
