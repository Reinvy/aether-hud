  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40">
      ...
      <nav
        ...
        className="bg-[#FAF8F5]/95 dark:bg-surface-primary/90 parchment-panel-strong dark:glass-panel-strong mx-4 mt-2 rounded-2xl px-4 py-2.5 sm:mx-6 lg:mx-8 border-2 border-leather-caramel/30 dark:border-gold-400/25 shadow-xl"
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="font-serif text-sm font-bold tracking-[0.18em] text-[#2C1E14] dark:text-platinum-50 uppercase">
                  {siteName}
                </span>
                <span className="text-[9px] font-mono tracking-widest text-[#8C6239] dark:text-gold-400/90 hidden sm:block font-bold">
                  TEYVAT CODEX
                </span>
              </div>
            </Link>
            ...
            <div className="hidden items-center gap-2 md:flex pl-3 border-l border-leather-caramel/20 dark:border-gold-400/20">
              ...
              <span className="text-[10px] font-mono tabular-nums text-[#8C6239] dark:text-gold-400/80 font-bold">
                // {sysVersion}
              </span>
            </div>
          </div>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "text-[#2C1E14] dark:text-gold-400 font-extrabold"
                      : "text-[#8C6239] dark:text-platinum-200 hover:text-[#2C1E14] dark:hover:text-gold-400"
                  )}
                >
                  {item.label}
                  {/* Hover line */}
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="rounded-full p-2 bg-leather-caramel/10 dark:bg-gold-400/10 border border-leather-caramel/30 dark:border-gold-400/30 text-[#2C1E14] dark:text-gold-400 hover:scale-105 transition-all focus-ring-gold"
            >
              {isNight ? (
            ...
            <div className="hidden items-center gap-2 lg:flex" aria-live="polite">
              <div className="flex items-center gap-2 rounded-full border border-leather-caramel/35 dark:border-gold-400/20 bg-[#F3EDDF] dark:bg-deep-space/50 px-3.5 py-1.5 shadow-sm">
                ...
                <span className="font-mono text-[10px] tracking-[0.15em] text-[#2C1E14] dark:text-gold-200 tabular-nums font-bold">
                  {time || "SYNCING…"}
                </span>
                <span className="text-[9px] font-mono text-[#8C6239] dark:text-gold-400/80 font-bold">
                  WIB
                </span>
              </div>
            </div>
            ...
            <Link
              ...
              className="hidden items-center gap-1.5 px-3.5 py-1.5 text-xs font-mono tracking-wider text-[#2C1E14] dark:text-gold-300 hover:text-[#8C6239] dark:hover:text-gold-400 bg-leather-caramel/15 dark:bg-gold-400/10 border border-leather-caramel/35 dark:border-gold-400/30 focus-ring-gold rounded-full transition-colors sm:inline-flex font-bold shadow-sm"
            >
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-leather-caramel/15 text-[#2C1E14] dark:text-gold-400 font-bold"
                      : "text-[#8C6239] dark:text-platinum-200 hover:bg-leather-caramel/10 hover:text-[#2C1E14]"
                  )}
                >
                  <span>{item.label}</span>
                  <span className="text-[9px] opacity-75 font-bold">{item.sysId}</span>
                </Link>
              );
            })}
            <Link
